...
test.describe('Project Management Workflow', () => {
  ...
  test('should upload images to project', async ({ page }) => {
    ...
    await expect(page.getByText(/test-image\.jpg|image.*uploaded/i)).toBeVisible()
  })
  ...
  test('should start segmentation process', async ({ page }) => {
    ...
    await expect(page.getByText(/processing|analyzing|in progress/i)).toBeVisible()
  })
  ...
  test('should show empty state when no projects exist', async ({ page }) => {
    ...
    await expect(page.getByText(/no projects|get started|create.*first/i)).toBeVisible()
  ...
  test('should handle project creation validation', async ({ page }) => {
    ...
    await expect(page.getByText(/project name.*required|name.*required/i)).toBeVisible()
    ...
    await expect(page.getByText(/name.*too long|maximum.*length/i)).toBeVisible()
  })
