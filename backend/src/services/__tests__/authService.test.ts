...
describe('AuthService', () => {
  ...
  describe('login', () => {
    ...
    it('should throw error if user not found', async () => {
      ...
      await expect(authService.login(loginData)).rejects.toThrow('Invalid login credentials')
    })
  ...
  describe('refreshToken', () => {
    ...
    it('should throw error if session not found', async () => {
      ...
      await expect(authService.refreshToken(refreshTokenData)).rejects.toThrow('Invalid or expired refresh token')
    })
    ...
    it('should throw error if session is expired', async () => {
      ...
      prismaMock.session.findUnique.mockResolvedValueOnce(expiredSession as any)
    ...
    it('should throw error if session is invalid', async () => {
      ...
      prismaMock.session.findUnique.mockResolvedValueOnce(invalidSession as any)
  ...
  describe('logout', () => {
    ...
    it('should handle logout error gracefully', async () => {
      ...
      await expect(authService.logout(refreshToken)).rejects.toThrow('Logout failed')
    })
  })
  ...
  describe('updateProfile', () => {
    ...
    it('should throw error if user not found', async () => {
      ...
      await expect(authService.updateProfile(userId, profileData)).rejects.toThrow('User not found')
    })
  })
  ...
  describe('deleteAccount', () => {
    ...
    it('should throw error if user not found', async () => {
      ...
      await expect(authService.deleteAccount(userId)).rejects.toThrow('User not found')
    })
  })
})