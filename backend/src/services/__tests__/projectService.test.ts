...
describe('ProjectService', () => {
  ...
  describe('createProject', () => {
    ...
    it('should handle creation error', async () => {
      ...
      await expect(projectService.createProject(userId, projectData)).rejects.toThrow('Database error')
    })
  })
  ...
  describe('checkProjectOwnership', () => {
    it('should return true for project owner', async () => {
      ...
      const result = await projectService.checkProjectOwnership(projectId, userId)
