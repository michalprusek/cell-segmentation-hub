...
export class QueueWorker {
  ...
  private async processQueue(): Promise<void> {
    ...
    try {
      ...
      logger.info(
        'Processing segmentation queue with parallel batches',
        'QueueWorker',
        {
      ...
      try {
        ...
        logger.error(
          'Failed to process parallel batches',
  ...
  private async resetStuckItemsOnStartup(): Promise<void> {
    try {
      ...
      logger.error(
        'Failed to reset stuck items on startup',
        error instanceof Error ? error : undefined,
        'QueueWorker'
      );
    }
  ...
  private async performQueueCleanup(): Promise<void> {
    try {
      ...
      logger.error(
        'Failed to perform queue cleanup',
        error instanceof Error ? error : undefined,
        'QueueWorker'
      );
    }
