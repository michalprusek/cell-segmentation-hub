export default {
  ...
  images: {
    ...
    upload: {
      ...
      op: {
        interrupted: 'Upload durch Seitenaktualisierung unterbrochen',
        uploadingFile: 'Wird hochgeladen ({{index}}/{{total}})',
        processingFile: 'Wird verarbeitet ({{index}}/{{total}})',
        completedSummary:
          'Upload abgeschlossen: {{success}} erfolgreich, {{failed}} fehlgeschlagen',
        preparing: '{{count}} Dateien werden vorbereitet...',
        uploadingVideo: 'Video {{index}}/{{total}} wird hochgeladen',
        processingOnServer: 'Verarbeitung auf dem Server',
        uploadedWithFailures:
          '{{uploaded}} hochgeladen, {{failed}} fehlgeschlagen',
        uploadedOk: '{{count}} Dateien erfolgreich hochgeladen',
        uploadingFiles: '{{count}} Dateien werden hochgeladen...',
        countUploaded: '{{count}} hochgeladen',
        countFailed: '{{count}} fehlgeschlagen',
        countCancelled: '{{count}} abgebrochen',
        noFiles: 'keine Dateien verarbeitet',
        retryingChunk: 'Block {{index}} wird wiederholt (Versuch {{attempt}})',
        processingChunk: 'Block {{index}} von {{total}} wird verarbeitet',
        chunksDone: '{{done}} von {{total}} Blöcken abgeschlossen',
        uploadingChunk: 'Block {{index}} von {{total}} wird hochgeladen',
        persistingOriginal: 'Original wird gespeichert',
        extractingFramesStart: 'Bilder werden extrahiert',
