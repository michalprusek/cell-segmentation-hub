export default {
  ...
  images: {
    ...
    upload: {
      ...
      op: {
        interrupted: 'Upload interrupted by page refresh',
        uploadingFile: 'Uploading ({{index}}/{{total}})',
        processingFile: 'Processing ({{index}}/{{total}})',
        completedSummary:
          'Upload completed: {{success}} successful, {{failed}} failed',
        preparing: 'Preparing to upload {{count}} files...',
        uploadingVideo: 'Uploading video {{index}}/{{total}}',
        processingOnServer: 'Processing on server',
        uploadedWithFailures: '{{uploaded}} uploaded, {{failed}} failed',
        uploadedOk: '{{count}} files uploaded successfully',
        uploadingFiles: 'Uploading {{count}} files...',
        countUploaded: '{{count}} uploaded',
        countFailed: '{{count}} failed',
        countCancelled: '{{count}} cancelled',
        noFiles: 'no files processed',
        retryingChunk: 'Retrying chunk {{index}} (attempt {{attempt}})',
        processingChunk: 'Processing chunk {{index}} of {{total}}',
        chunksDone: 'Completed {{done}} of {{total}} chunks',
        uploadingChunk: 'Uploading chunk {{index}} of {{total}}',
        persistingOriginal: 'Persisting original',
        extractingFramesStart: 'Extracting frames',
  ...
  segmentation: {
    ...
    neurite: {
      ...
      assignNeedsScale:
        'Set the project scale (µm per pixel) first — the assignment measures in micrometres.',
      somaLabel: 'Soma {{n}}',
