export default {
  ...
  projects: {
    ...
    createProjectDesc:
      'Ajoutez un nouveau projet pour organiser vos images de microscopie et analyses.',
    ...
    projectDescPlaceholder:
      'ex. : Analyse de cultures traitées par médicament pour des études de résistance',
