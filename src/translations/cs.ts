export default {
  ...
  images: {
    ...
    upload: {
      ...
      op: {
        interrupted: 'Nahrávání přerušeno obnovením stránky',
        uploadingFile: 'Nahrávání ({{index}}/{{total}})',
        processingFile: 'Zpracování ({{index}}/{{total}})',
        completedSummary:
          'Nahrávání dokončeno: {{success}} úspěšně, {{failed}} selhalo',
        preparing: 'Příprava nahrávání {{count}} souborů...',
        uploadingVideo: 'Nahrávání videa {{index}}/{{total}}',
        processingOnServer: 'Zpracování na serveru',
        uploadedWithFailures: '{{uploaded}} nahráno, {{failed}} selhalo',
        uploadedOk: '{{count}} souborů úspěšně nahráno',
        uploadingFiles: 'Nahrávání {{count}} souborů...',
        countUploaded: '{{count}} nahráno',
        countFailed: '{{count}} selhalo',
        countCancelled: '{{count}} zrušeno',
        noFiles: 'nezpracovány žádné soubory',
        retryingChunk: 'Opakování části {{index}} (pokus {{attempt}})',
        processingChunk: 'Zpracování části {{index}} z {{total}}',
        chunksDone: 'Dokončeno {{done}} z {{total}} částí',
        uploadingChunk: 'Nahrávání části {{index}} z {{total}}',
        persistingOriginal: 'Ukládání originálu',
        extractingFramesStart: 'Extrahování snímků',
  ...
  segmentation: {
    ...
    neurite: {
      ...
      assignNeedsScale:
        'Nejdřív nastavte měřítko projektu (µm na pixel) — přiřazení měří v mikrometrech.',
      somaLabel: 'Soma {{n}}',
