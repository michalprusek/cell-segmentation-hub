...
const EnhancedSegmentationEditor: React.FC<EnhancedSegmentationEditorProps> = ({
  ...
  return (
    ...
    >
      ...
      {/* Status Bar */}
      <div className="flex items-center justify-between px-4 py-2 bg-gray-50 dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 text-sm text-gray-600 dark:text-gray-400 dark:bg-gray-900">
