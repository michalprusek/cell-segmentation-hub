...
describe('useEnhancedSegmentationEditor', () => {
  ...
  describe('Initialization', () => {
    it('initializes with correct default state', () => {
      const { result } = renderHook(() => useEnhancedSegmentationEditor(defaultProps))
  ...
  describe('Polygon Management', () => {
    it('updates polygons and tracks history', () => {
      ...
      const newPolygon: Polygon = {
        id: 'polygon-2',
        points: [{ x: 60, y: 60 }, { x: 100, y: 60 }, { x: 100, y: 100 }, { x: 60, y: 100 }],
        confidence: 0.8
      }
      ...
      expect(defaultProps.onPolygonsChange).toHaveBeenCalledWith([mockPolygon, newPolygon])
    })
